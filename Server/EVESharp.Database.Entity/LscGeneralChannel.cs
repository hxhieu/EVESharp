...
[Table("lscGeneralChannels")]
[Index("OwnerId", Name = "FK_CHANNELS_OWNER")]
[Index("RelatedEntityId", Name = "FK_CHANNELS_RELEATEDENTITY")]
[MySqlCharSet("utf8mb3")]
[MySqlCollation("utf8mb3_unicode_ci")]
public partial class LscGeneralChannel
{
    [Key]
    ...
    [Column("relatedEntityID", TypeName = "int(10) unsigned")]
    public uint? RelatedEntityId { get; set; }
